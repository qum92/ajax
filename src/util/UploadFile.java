...
public class UploadFile {
	...
	private static final int MEMORY_SIZE = 1000*1024*1024;
	private static final int TOTAL_SIZE = 10000*1024*1024;
	private static final int FILE_SIZE = 10000*1024*1024;
	...
	public static Map<String,Object> paseRequest(HttpServletRequest request) throws ServletException{
